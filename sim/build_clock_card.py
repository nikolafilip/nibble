...
def main():
    ...
    w.at(w.R('10k',x+14.5*G,y2,90),46,86,270); w.W(x+16*G,y2,x+17*G,y2); w.L('CLK',x+17*G,y2,0,'bidirectional')
    ...
    xr=x+30*G; w.L('PA',xr,y3,180,'input'); w.W(xr,y3,xr+G,y3); w.at(w.R('10k',xr+2.5*G,y3,90),64,86,270); w.W(xr+4*G,y3,xr+5*G,y3)
