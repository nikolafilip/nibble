...
BUTTONS=['CLK','RST']
LEDS=['A3','A2','A1','A0','B3','B2','B1','B0','PC3','PC2','PC1','PC0','M7','M6','M5','M4','M3','M2','M1','M0','CF','ZF','CLK','RST',
      'SUB','EO','AI','AO','BI','BA','AB','OI','IO','II','PCE','PCL','FI','HLT']
...
def build():
    ...
    d.group='leds'
    for i in (3,2,1,0): d.led(f'LED_D{i}',f'D{i}')
    for n in LEDS: d.led(f'LED_{n}',n)
    return d
